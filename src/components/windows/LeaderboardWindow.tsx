...
const FALLBACK_ROWS: Row[] = [
  {
    ...
    badges: [{ en: 'Champion · 1,500 USDC', zh: '冠军 · 1,500 USDC', c: 'gold' }], tool: 'Claude Code', score: 87.5, cls: 'top1',
  ...
  },
  {
    ...
    badges: [{ en: 'Runner-up · 599 USDC', zh: '亚军 · 599 USDC', c: '' }], tool: 'Codex', score: 86.6, cls: 'top2',
  ...
  },
  {
    ...
    badges: [{ en: '3rd · 550 USDC', zh: '季军 · 550 USDC', c: '' }], tool: 'Gemini CLI', score: 84.1, cls: 'top3',
  ...
  },
  {
    ...
    badges: [{ en: 'Excellence · 500 USDC', zh: '优秀作品奖 · 500 USDC', c: '' }], tool: 'Claude Code', score: 82.5, cls: '',
  ...
  },
  {
    ...
    badges: [{ en: 'Excellence · 500 USDC', zh: '优秀作品奖 · 500 USDC', c: '' }], tool: 'Cursor', score: 82.3, cls: '',
  ...
  },
  {
    ...
    badges: [
      { en: 'Excellence · 500 USDC', zh: '优秀作品奖 · 500 USDC', c: '' },
      { en: '★ Best Human-AI Collab · 450 USDC', zh: '★ 最佳人机协作 · 450 USDC', c: 'star' },
