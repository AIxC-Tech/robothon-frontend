...
const FAQS: { en: [string, string]; zh: [string, string] }[] = [
  {
    en: ['What is this hackathon?', 'A MuJoCo-based robot-simulation hackathon: build a simulator, task scenario or data-collection system with MuJoCo, get scored by three AI judges against the official rubric, and climb the live leaderboard.'],
    zh: ['这是什么比赛？', '基于 MuJoCo 的机器人仿真黑客松：用 MuJoCo 构建仿真器、任务场景或数据采集系统，由三位 AI 评审按官方标准打分，作品登上实时排行榜。'],
  },
  ...
  { en: ['What environment do I need?', 'MuJoCo is the primary physics engine — one-line pip install, all platforms, no GPU required.'], zh: ['需要什么环境？', '以 MuJoCo 为主要物理仿真引擎——一行 pip 安装、全平台、无需 GPU。'] },
  {
    ...
    zh: ['可以做哪些方向？', '推荐方向：复杂遥操作（键盘 / 手柄 / VR / 动作捕捉）、长程任务（导航 / 抓取 / 搬运 / 装配 / 开门 / 整理）、数据采集、灵巧手操作、实际场景（K12 / 安防 / 家庭服务 / 仓储物流 / 工业巡检），也欢迎任意有创意的 MuJoCo 机器人仿真项目。特别鼓励灵巧手方向。'],
  },
  {
    ...
    zh: ['可以用哪些机器人？', '任意本体：机械臂、移动机器人、四足机器人、人形机器人、夹爪、无人车、灵巧手 / 多指机械手等。'],
  },
  {
    en: ['How do I submit?', 'Submit: code repo + run instructions (dependencies / install / launch / controls) + MuJoCo scene & robot model + a 1–3 min demo video (produced by running the submitted code) + a project write-up (name / embodiment / task goal / approach / core features / highlights / limitations & future work). The latest submission of a project is the one that counts.'],
  ...
  },
  {
    ...
    zh: ['怎么评分？', '三位 AI 评审（Claude / GPT / Gemini）按 8 个维度锚定式打分：可运行性、MuJoCo 使用深度、任务设计、控制能力、灵巧操作、工程质量、展示效果、创新性；每家取中位数后三者平均得出总分。'],
  },
  {
    en: ['How do I register?', 'No form to fill out — just chat in the “AI Registration Assistant” window to finish registering.'],
